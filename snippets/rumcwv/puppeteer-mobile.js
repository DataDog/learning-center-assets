...
const runSession = async (url, selectors, page) => {
...
(async () => {
  ...
  await runSession(startUrl, selectors, pageOne);
})();
...
(async () => {
  ...
  await runSession(startUrl, selectors, pageTwo);
})();
...
(async () => {
  ...
  await runSession(startUrl, selectors, pageThree);
})();
...
(async () => {
  ...
  await runSession(startUrl, selectors, pageFour);
})();
...
(async () => {
  ...
  await runSession(startUrl, selectors, pageFive);
})();
