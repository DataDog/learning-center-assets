...
def create_monitor(monitor_name, dashboard_url):
    ...
    with ApiClientV1(configuration) as api_client:
        ...
        body = Monitor(
            ...
            query="avg(last_1m):avg:trace.rack.request{env:incident-management,resource_name:spree::homecontroller_index,service:store-frontend} > 2",
            tags=["service:store-frontend", "env:incident-management", "resource_name:spree::homecontroller_index"],
...
console = Console()
monitor_name = "Monitor for Incident Management Course"
